...
BRCMFMAC_8812_URL:=https://raw.githubusercontent.com/mj22226/rtw88/master/firmware/

define Download/rtl8812au-firmware
  FILE:=rtw8812a_fw.bin
  URL:=$(BRCMFMAC_8812_URL)
  HASH:=abdcca4e8bf76ebfba23d433de310ffefebd0ff9d01990639d4cd9602b32b71a
endef

BRCMFMAC_8821_URL:=https://raw.githubusercontent.com/mj22226/rtw88/master/firmware/

define Download/rtl8821a-firmware
  FILE:=rtw8821a_fw.bin
  URL:=$(BRCMFMAC_8821_URL)
